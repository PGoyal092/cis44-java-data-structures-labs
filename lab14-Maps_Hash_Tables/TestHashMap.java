...
public class TestHashMap {
    public static void main(String[] args) {
        ...
        System.out.println("put(Aa, X): " + map.put(k1, "X"));
        System.out.println("put(BB, Y): " + map.put(k2, "Y"));  // collision with Aa
        System.out.println("put(@b, Z): " + map.put(k3, "Z"));

        System.out.println();

        System.out.println("get(Aa): " + map.get(k1));
        System.out.println("get(BB): " + map.get(k2));
        System.out.println("get(@b): " + map.get(k3));

        System.out.println();

        System.out.println("remove(BB): " + map.remove(k2));
        System.out.println("get(BB): " + map.get(k2));
